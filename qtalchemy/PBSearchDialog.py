...
from sqlalchemy.orm import mapper, create_session, relationship, object_session
...
class PBSearchableListDialog(QDialog):
    """
    ...
    def __init__(self, parent=None, extensionId=None):
        QDialog.__init__(self, parent, QtCore.Qt.Dialog)
        ...
        self.searchGo = QPushButton("&Refresh")
...
class PBSearchDialog(PBSearchableListDialog):
    ...
    def __init__(self, ssrc, entityCls, parent=None):
        ...
        self.toolbar = LayoutWidget(self.layout(), QToolBar(self))
        buttonbox = LayoutWidget(self.layout(),QDialogButtonBox())
        ...
        select = buttonbox.addButton("Selec&t", QDialogButtonBox.ActionRole)
...
class PBTableTab(QWidget):
    ...
    def __init__(self, parent, ssrc, entityCls, filters=None, query=None, extensionId=None, objectConverter=None):
        ...
        self.toolbar = LayoutWidget(layout, QToolBar(self))
