...
class TextYoke(InputYoke):
    ...
    def Bind(self):
        if isinstance(self.widget, QLineEdit) or isinstance(self.widget, QTextEdit):
            self.widget.setText(self.mapper.getObjectAttr(self.attr))
    ...
    def Save(self):
        ...
        if isinstance(self.widget, QTextEdit) or isinstance(self.widget, QPlainTextEdit):
...
class BooleanYoke(InputYoke):
    ...
    def Factory(self):
        self.widget = QCheckBox(ClassAttributeLabel(getattr(self.mapper.cls,self.attr)))
        self._baseAdoptWidget(self.widget)
...
class BooleanRadioYoke(InputYoke):
    ...
    def AdoptWidget(self, widget):
        ...
        if self.true_radio.group() is None:
            ...
            self.group = QButtonGroup(self.true_radio.parent())
...
class ImageYoke(InputYoke):
    ...
    def _baseAdoptWidget(self, widget):
        ...
        if not attrReadonly(self.mapper.cls, self.attr):
            ...
            self.action_set_image = QAction('Assign &Image...', widget)
