...
class MDIWindow(QtWidgets.QMdiSubWindow, ToolBase):
    def __init__(self, parent=None):
        super(MDIWindow, self).__init__(parent)
        self.setWindowFlags(QtCore.Qt.Window)
        self.setWindowFlags(QtCore.Qt.WindowTitleHint | QtCore.Qt.WindowCloseButtonHint | QtCore.Qt.WindowMinimizeButtonHint)
        self.setWindowIcon(QtGui.QIcon(":/mainIcon.png"))
        self.setAttribute(QtCore.Qt.WA_DeleteOnClose)
        self.setObjectName("MDIWindow")
    ...
    def onShow(self):
        super(MDIWindow, self).onShow()
        self.setWindowTitle(self.name())

    def restoreState(self, settings):
        super(MDIWindow, self).restoreState(settings)
        self.setObjectName(self.uniqueName())
