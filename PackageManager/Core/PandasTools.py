...
''' >>> import sys, pandas >>> from DataFrameGUI import DataFrameApp >>> df = pandas.DataFrame([1,2,3]) >>> root = QApplication(sys.argv) >>> app = DataFrameApp(df) >>> app.show() >>> root.exec_()'

 - To build your own widget, subclass DataFrameWidget

"""
#from PySide6 import QVariant
