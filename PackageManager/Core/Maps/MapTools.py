...
from PySide6.QtCore import (Signal, QBasicTimer, QObject, QPoint, QPointF,
                          QRect, QSize, QStandardPaths, Qt, QUrl)
from PySide6.QtGui import (QColor, QDesktopServices, QImage, QPainter,
                         QPainterPath, QPixmap, QAction, QRadialGradient)
...
class SlippyMap(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.height = 300
        self.zoom = 15
        self.latitude = 55.251666666
        self.longitude = -118.79916666
    ...
    def download(self):
        ...
        # path = "http://maps.googleapis.com/maps/api/geocode/xml"
