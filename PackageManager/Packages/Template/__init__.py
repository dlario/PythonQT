...
"""Base package
"""
from PackageManager.Packages.Template.Resources import RESOURCES_DIR, ICON_DIR

PACKAGE_NAME = 'Template'

from collections import OrderedDict
from PackageManager.UI.UIInterfaces import IPackage
from PackageManager.Packages.Template import AppMDI
...
# [Imports]
from PackageManager.Packages.Template.Commands.NewFile import NewFile
from PackageManager.Packages.Template.Commands.SaveFile import SaveFile
from PackageManager.Packages.Template.Commands.OpenFile import OpenFile
from PackageManager.Packages.Template.Commands.CloseFile import CloseFile
from PackageManager.Packages.Template.Commands.LoadForm import LoadForm

from PackageManager.Packages.Template.Commands.LoadDefaultData import LoadDefaultData
from PackageManager.Packages.Template.Commands.DropTables import DropTables

from PackageManager.Packages.Template.Commands.About import About
from PackageManager.Packages.Template.Commands.HomePage import HomePage

# from PackageManager.Packages.ProgramBase.UI.DockWindows.SearchResultsTool import SearchResultsTool

# [Prefs widgets]
from PackageManager.Packages.Template.PrefsWidgets.General import GeneralPreferences
from PackageManager.Packages.Template.PrefsWidgets.InputPrefs import InputPreferences
...
_PREFS_WIDGETS["Template - General"] = GeneralPreferences
_PREFS_WIDGETS["Template - Input"] = InputPreferences
...
class Template(IPackage):
    ...
    def GetDefaultRibbonLayout():
        ...
        itemList.append({'Bar': 'Home', 'Section': 'File', 'Widget': 'Large Button',
                         ...
                         'Package': 'Template', 'PackageGroup': 'Template', 'Command': 'NewFile',
                         'Order': 1,
        ...
        itemList.append({'Bar': 'Home', 'Section': 'File', 'Widget': 'Large Button',
                         ...
                         'Package': 'Template', 'PackageGroup': 'Template', 'Command': 'OpenFile',
                         'Order': 1,
        ...
        itemList.append({'Bar': 'Home', 'Section': 'File', 'Widget': 'Large Button',
                         ...
                         'Package': 'Template', 'PackageGroup': 'Template', 'Command': 'SaveFile',
                         'Order': 1,
        ...
        itemList.append({'Bar': 'Home', 'Section': 'File', 'Widget': 'Large Button',
                         ...
                         'Package': 'Template', 'PackageGroup': 'Template', 'Command': 'LoadForm',
                         'Order': 1,
        ...
        itemList.append({'Bar': 'DatabaseTool', 'Section': 'Commands', 'Widget': 'Large Button',
                         ...
                         'Package': 'Template', 'PackageGroup': 'Template', 'Command': 'LoadDefaultData',
                         'Order': 1,
        ...
        itemList.append({'Bar': 'DatabaseTool', 'Section': 'Commands', 'Widget': 'Large Button',
                         ...
                         'mediumIconLocation': ICON_DIR + 'construction - Medium.png',
                         'largeIconLocation': ICON_DIR + 'construction - Large.png', 'Action': 'Add Action',
                         'Package': 'ProjectList', 'PackageGroup': 'Template', 'Command': 'DropTables', 'Order': 1,
                         'StartPosition': (1, 1), 'Fixity': 'Order', 'WidgetSize': (1, 1), 'DisplayName': 'Test 3',
                         'ShowName': False, 'ToolTip': 'New Project', 'IsActive': True, 'MainVisible': True,
                         'InstanceVisible': True})
