...
from PackageManager.Packages.Template.UI.Forms.frmTemplate import frmTemplate as loadedForm

class LoadForm(ShelfTool):
    def __init__(self):
    ...
    def do(self):
        ...
        self.ProgramManagerInstance.instance.newSubFormFromUi(loadedForm(self.ProgramManagerInstance,
                                                                         self.ProgramManagerInstance))
