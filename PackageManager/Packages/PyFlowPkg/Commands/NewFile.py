...
class NewFile(ShelfTool):
    ...
    def do(self):
        newClass = self.PackageInstance.instance.instance(self.ProgramManagerInstance, "any")
        self.ProgramManagerInstance.instance.newFile(newClass)