...
def loadformdata(Base, formname, itemdata = {}):
    ...
    if formname == "Activity":
        itemdata["Form_id"] = 2
        itemdata["FormName"] = "Activity"
        itemdata["MainTableClass"] = Activity
        itemdata["AttributeTableClass"] = ActivityAttribute
        itemdata["AttributeTableName"] = "activityattribute"
        itemdata["AttributeTable_id"] = None
        itemdata["CollectionAttributeTableName"] = "attActivity"
        itemdata["CollectionAttributeTable_id"] = -1

    if formname == "Company":
        itemdata["Form_id"] = 3
        itemdata["FormName"] = "Company"
        itemdata["MainTableClass"] = Company
        itemdata["AttributeTableClass"] = CompanyAttribute
        itemdata["AttributeTableName"] = "Companyattribute"
        itemdata["AttributeTable_id"] = None
        itemdata["CollectionAttributeTableName"] = "attCompany"
        itemdata["CollectionAttributeTable_id"] = -1

    if formname == "Equipment":
        itemdata["Form_id"] = 4
        itemdata["FormName"] = "Equipment"
        itemdata["MainTableClass"] = Equipment
        itemdata["AttributeTableClass"] = EquipmentAttribute
        itemdata["AttributeTableName"] = "equipmentattribute"
        itemdata["AttributeTable_id"] = None
        itemdata["CollectionAttributeTableName"] = "attEquipment"
        itemdata["CollectionAttributeTable_id"] = -1

    if formname == "Task Group":
        itemdata["Form_id"] = 6
        itemdata["FormName"] = "Task Group"
        #itemdata["MainTableClass"] = Task
        itemdata["AttributeTableClass"] = TaskGroupAttribute
        itemdata["AttributeTableName"] = "taskgroupattribute"
        itemdata["AttributeTable_id"] = None
        itemdata["CollectionAttributeTableName"] = "atttaskgroup"
        itemdata["CollectionAttributeTable_id"] = -1
