...
from PackageManager.UI.Widgets.PropertiesFramework import CollapsibleFormWidget
...
class GeneralPreferences(CategoryWidgetBase):
    ...
    def __init__(self, parent=None):
        ...
        defaultTempFolder = os.path.join(os.path.expanduser('~'), "PackageManagerTemp")
    ...
    def initDefaults(self, settings):
        ...
        settings.setValue("TempFilesDir", os.path.expanduser('~/PackageManagerTemp'))
