...
from PyFlow.AppMDI import PyFlow
...
class NewInstance(ShelfTool):
    ...
    @staticmethod
    def name():
        return str("New Instance")

    def do(self):
        self.ProgramManagerInstance.instance.loadInstance(PyFlow(self.ProgramManagerInstance.instance, None))
