...
class MDIMain(MDIMain):
    ...
    def __init__(self, main, parent=None, software=""):
        super(MDIMain, self).__init__(main)
    ...
    def about(self):
        QMessageBox.about(self, "About XFiles",
                          "The <b>XFiles</b> is a XFiles for making packages "
                          "change this accordingly.")

    def loadModel(self, modelName, modelPath, allowDownload=False):
        self.model = GPT4All(model_name=modelName, model_path=modelPath, allow_download=allowDownload)
...
class MDIChild(QMdiSubWindow):
    ...
    def __init__(self, main, parent):
        ...
        settings = ConfigManager().getSettings("APP_STATE")
        self.PackageName = "XFiles-MDIChild"
