...
from PackageManager import GET_PACKAGE_PATH
...
class NodeBoxTreeWidget(QTreeWidget):
    ...
    def refresh(self, pattern='', pinDirection=None, pinStructure=StructureType.Single):
        ...
        a = self.main.actionRegister
        b = self.main.instance.packageRegister.GET_PACKAGES()
        c = self.main.instance.commandRegister

        self.PACKAGES = self.main.instance.packageRegister.GET_PACKAGES()
        for package_name, package in self.PACKAGES.items():
            # annotated functions
            a = package.GetFunctionLibraries()
            ...
            packagePath = self.main.instance.packageRegister.GET_PACKAGE_PATH(package_name)
            ...
            if False: #os.path.exists(compoundNodesRoot):
