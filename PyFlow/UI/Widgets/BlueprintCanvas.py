...
def getNodeInstance(jsonTemplate, canvas, main, parentGraph=None):
    ...
    kwargs['main'] = main
    raw_instance = main.instance.packageRegister.getRawNodeInstance(nodeClassName, packageName=packageName, libName=libName, **kwargs)
...
class BlueprintCanvas(CanvasBase):
    ...
    def _createNode(self, jsonTemplate):
        ...
        nodeInstance = getNodeInstance(jsonTemplate, self, self.main)
